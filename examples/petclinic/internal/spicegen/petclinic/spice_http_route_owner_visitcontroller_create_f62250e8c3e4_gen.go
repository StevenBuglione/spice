...
func registerGeneratedRouteOwnerVisitControllerCreate_f62250e8(
	ctx context.Context,
	...
	_ = dependencies
	_ = httpObservers
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/petclinic/owner|15:VisitController|6:Create", Module: "", Method: "POST", Pattern: "/owners/{ownerId}/pets/{petId}/visits/new"}, httpObservers...)
	...
	if routeErr := spiceweb.RegisterObserved(routeMux, "POST /owners/{ownerId}/pets/{petId}/visits/new", http.HandlerFunc(func(writer http.ResponseWriter, httpRequest *http.Request) {
		...
		responseValue, routeErr := dependencies.visitController.Create(httpRequest.Context(), requestValue, bindingResult)
		if routeErr != nil {
