...
func registerGeneratedRouteOwnerPetControllerUpdate_53ee21b4(
	ctx context.Context,
	...
	_ = dependencies
	_ = httpObservers
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/petclinic/owner|13:PetController|6:Update", Module: "", Method: "POST", Pattern: "/owners/{ownerId}/pets/{petId}/edit"}, httpObservers...)
	if routeObservationErr0 != nil {
		return nil, application.coordinator.Abort(ctx, fmt.Errorf("configure generated route POST /owners/{ownerId}/pets/{petId}/edit observation: %w", routeObservationErr0))
	}
	if routeErr := spiceweb.RegisterObserved(routeMux, "POST /owners/{ownerId}/pets/{petId}/edit", http.HandlerFunc(func(writer http.ResponseWriter, httpRequest *http.Request) {
		...
		responseValue, routeErr := dependencies.petController.Update(httpRequest.Context(), requestValue, bindingResult)
		if routeErr != nil {
