...
func registerGeneratedRouteOwnerPetControllerNewForm_30d451cf(
	ctx context.Context,
	...
	_ = dependencies
	_ = httpObservers
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/petclinic/owner|13:PetController|7:NewForm", Module: "", Method: "GET", Pattern: "/owners/{ownerId}/pets/new"}, httpObservers...)
	if routeObservationErr0 != nil {
		return nil, application.coordinator.Abort(ctx, fmt.Errorf("configure generated route GET /owners/{ownerId}/pets/new observation: %w", routeObservationErr0))
	}
	routeTerminal := func(invocationContext context.Context, invocationRequest owner.NewPetRequest) (spiceview.Result, error) {
		return dependencies.petController.NewForm(invocationContext, invocationRequest)
	}
	routeInvocation, routeInterceptorErr := spiceintercept.Chain(
		routeTerminal,
		options.Interceptors.PetControllerNewForm...,
	)
	if routeInterceptorErr != nil {
		return nil, application.coordinator.Abort(ctx, fmt.Errorf("construct generated typed interceptors for route GET /owners/{ownerId}/pets/new: %w", routeInterceptorErr))
	}
