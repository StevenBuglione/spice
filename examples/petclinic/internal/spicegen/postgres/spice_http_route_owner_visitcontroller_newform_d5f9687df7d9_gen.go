...
func registerGeneratedRouteOwnerVisitControllerNewForm_d5f9687d(
	ctx context.Context,
	...
	_ = dependencies
	_ = httpObservers
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/petclinic/owner|15:VisitController|7:NewForm", Module: "", Method: "GET", Pattern: "/owners/{ownerId}/pets/{petId}/visits/new"}, httpObservers...)
