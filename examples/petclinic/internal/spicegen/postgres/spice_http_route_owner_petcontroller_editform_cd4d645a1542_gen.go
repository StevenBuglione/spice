...
func registerGeneratedRouteOwnerPetControllerEditForm_cd4d645a(
	ctx context.Context,
	...
	_ = dependencies
	_ = httpObservers
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/petclinic/owner|13:PetController|8:EditForm", Module: "", Method: "GET", Pattern: "/owners/{ownerId}/pets/{petId}/edit"}, httpObservers...)
