...
func registerGeneratedRouteOwnerPetControllerCreate_55f9d3e7(
	ctx context.Context,
	...
	_ = dependencies
	_ = httpObservers
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|56:github.com/StevenBuglione/spice/examples/petclinic/owner|13:PetController|6:Create", Module: "", Method: "POST", Pattern: "/owners/{ownerId}/pets/new"}, httpObservers...)
