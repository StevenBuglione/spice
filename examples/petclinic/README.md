...
For a first run from a fresh checkout, follow the repository's
[`getting-started.md`](../../docs/getting-started.md) walkthrough. The commands
below are the complete target and database-profile reference.
