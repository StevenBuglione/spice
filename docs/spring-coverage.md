...
| Core | Starters and dependency alignment | A public strict `spice.starter/v1` SDK provides deterministic compatibility, dependency-review, explicit activation/entrypoint, qualified annotation, and application-feature metadata; PostgreSQL, OIDC, OAuth2-client, and OpenTelemetry packages publish validated constructor manifests, while repository discovery, compiler adapters, generated selection, and dependency alignment follow | in-progress |
