...
| Core | Starters and dependency alignment | A public strict `spice.starter/v1` SDK provides deterministic compatibility, dependency-review, explicit activation/entrypoint, qualified annotation, and application-feature metadata; repository discovery, compiler adapters, generated selection, and dependency alignment follow | in-progress |
