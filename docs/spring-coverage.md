...
| Core | Starters and dependency alignment | A public strict `spice.starter/v1` SDK and committed `spice.starters/v1` repository selection provide fail-closed compatibility, annotation/feature composition, and generation freshness without dependency-presence activation; PostgreSQL, OIDC, OAuth2-client, and OpenTelemetry publish constructor manifests, while generated selection and dependency alignment follow | in-progress |
