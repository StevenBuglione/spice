...
| Data | PostgreSQL, Redis, MongoDB, Elasticsearch, Cassandra, Neo4j | A reviewed pgx `database/sql` starter provides secure PostgreSQL pool configuration and real-container transaction/query verification; other curated client starters follow | in-progress |
