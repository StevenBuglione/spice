...
| Observability | Actuator endpoints | Explicit `@management.Enable` allowlists deterministically generate exactly selected health/liveness/readiness/info/metrics/configprops routes, lifecycle-state probes, bounded route metrics, and schema-backed configuration provenance with mandatory secret redaction; broader module metadata follows | in-progress |
