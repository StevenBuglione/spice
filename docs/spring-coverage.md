...
| Core | Starters and dependency alignment | A public strict `spice.starter/v1` SDK provides deterministic compatibility and dependency-review metadata; an explicit fail-closed compiler catalog composes qualified annotations/features into application IR and generation freshness; PostgreSQL, OIDC, OAuth2-client, and OpenTelemetry publish validated constructor manifests, while repository/CLI composition, generated selection, and dependency alignment follow | in-progress |
