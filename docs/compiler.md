...
aliases, generated configuration schema/binders, direct exported provider calls
in dependency-first order, existing graph-edge arguments, immediate cleanup
registration, wrapped stable errors, and direct lifecycle method values.
