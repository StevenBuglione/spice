...
The feature compiler is an explicit typed definition seam for future qualified
annotations. It is not yet a public third-party starter SDK. Definitions must
be deliberately supplied; imports and `go.mod` entries have no activation
effect.
