...
func TestRegistryContainsBuiltInDefinitions(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Bean", targets: []annotation.Target{annotation.TargetFunction, annotation.TargetMethod}},
		{name: "Component", targets: []annotation.Target{annotation.TargetType}},
		{name: "async.Execute", targets: []annotation.Target{annotation.TargetMethod}},
		...
		{name: "ConfigurationProperties", targets: []annotation.Target{annotation.TargetType}, argumentName: "prefix", kinds: []annotation.Kind{annotation.KindString}},
		...
		{name: "Enum", targets: []annotation.Target{annotation.TargetType}},
		{name: "data.Transactional", targets: []annotation.Target{annotation.TargetMethod}},
		{name: "event.Listener", targets: []annotation.Target{annotation.TargetMethod}, argumentName: "order", kinds: []annotation.Kind{annotation.KindInteger}},
		{name: "event.Topic", targets: []annotation.Target{annotation.TargetType, annotation.TargetFunction}},
